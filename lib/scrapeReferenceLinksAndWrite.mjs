...
async function writeLinksToFolder(accidentId, folder) {
...
export async function scrapeReferenceLinksAndWrite(accidentIds, folder) {
    for (let id of accidentIds) {
        await writeLinksToFolder(id, folder);
    }
}
